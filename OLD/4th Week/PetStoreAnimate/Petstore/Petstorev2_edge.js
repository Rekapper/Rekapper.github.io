...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Dog',
                            type: 'image',
                            rect: ['643px', '-14px', '133px', '201px', 'auto', 'auto'],
                    ...
                    style: {
                        '${Stage}': {
                            isStage: true,
                            rect: [undefined, undefined, '761px', '150px'],
                            overflow: 'hidden',
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            "easeInSine",
                            "${bird2}",
                            [[1027.9, 12.13, 0, 0, 0, 0,0],[855.85, 76.76, -68.84, 7.71, -264.27, 29.6,185.13],[728.9, 29.64, -459.54, 23.65, -73.21, 3.77,321.29],[463.83, 75.31, 0, 0, 0, 0,590.92]]
                        ],
                        [
                            "eid19",
                            "location",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("Petstorev2_edgeActions.js");
})("EDGE-29529260");
